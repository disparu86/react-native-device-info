...
@interface RNDeviceInfo() <CLLocationManagerDelegate>
...
RCT_EXPORT_METHOD(isGPSOpen:(RCTResponseSenderBlock)callback)
{
    NSString *value = [self nameForAuthorizationStatus:[CLLocationManager authorizationStatus]];
